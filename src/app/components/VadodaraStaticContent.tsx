...
export default function VadodaraStaticContent({ perGram22k, perGram24k }: VadodaraStaticContentProps) {
  return (
    <div className="mt-8 space-y-6">
      ...
      <section className="rounded-3xl border border-slate-100 bg-white p-6 shadow-soft">
        <h2 className="text-xl font-bold text-charcoal">Gold Rates by Carat in Vadodara</h2>
        <div className="mt-4 text-sm text-slate-600 leading-relaxed space-y-4">
      ...
      <section className="rounded-3xl border border-slate-100 bg-white p-6 shadow-soft">
        ...
        <div className="mt-4 text-sm text-slate-600 leading-relaxed space-y-4">
          <ul className="mt-2 space-y-2 list-disc list-inside">
            ...
            <li>Compare prices at Mandvi Gate and branded showrooms</li>
          </ul>
          <p>Popular jewellers: Tribhovandas Bhimji Zaveri, Tanishq, Kalyan, and local traditional jewellers.</p>
        </div>
      </section>
      ...
      <section className="rounded-3xl border border-slate-100 bg-white p-6 shadow-soft">
        ...
        <div className="mt-4 text-sm text-slate-600 leading-relaxed space-y-4">
          ...
          <p>GoldMeter provides daily updated gold rates for Vadodara.</p>
        </div>
      </section>
    </div>
  );
