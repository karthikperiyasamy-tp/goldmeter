    ...
    <div className="mt-8 space-y-6">
      <section className="rounded-3xl border border-slate-100 bg-white p-6 shadow-soft">
        ...
        <div className="mt-4 text-sm text-slate-600 leading-relaxed space-y-4">
          ...
          <p>
            ...
            Maharashtrian designs are popular alongside contemporary styles.
          </p>
        </div>
      </section>

      <section className="rounded-3xl border border-slate-100 bg-white p-6 shadow-soft">
        <h2 className="text-xl font-bold text-charcoal">Gold Rates by Carat in Nashik</h2>
        <div className="mt-4 text-sm text-slate-600 leading-relaxed space-y-4">
          <ul className="mt-2 space-y-2 list-disc list-inside">
            <li><strong>24 Carat Gold Rate</strong> - 99.9% pure for investment</li>
            <li><strong>22 Carat Gold Rate (916)</strong> - Standard for Maharashtrian jewellery</li>
      ...
      <section className="rounded-3xl border border-slate-100 bg-white p-6 shadow-soft">
        ...
        <div className="mt-4 text-sm text-slate-600 leading-relaxed space-y-4">
          <ul className="mt-2 space-y-2 list-disc list-inside">
            ...
            <li><strong>Peak Seasons</strong> - Gudi Padwa, Diwali, Kumbh Mela years, wedding season</li>
          </ul>
        </div>
      </section>
      ...
      <section className="rounded-3xl border border-slate-100 bg-white p-6 shadow-soft">
        ...
        <div className="mt-4 text-sm text-slate-600 leading-relaxed space-y-4">
          <ul className="mt-2 space-y-2 list-disc list-inside">
            ...
            <li>Compare prices at Main Road and branded showrooms</li>
          </ul>
          <p>Popular jewellers: PNG, Tanishq, Kalyan, and local traditional jewellers.</p>
        </div>
      </section>
      ...
      <section className="rounded-3xl border border-slate-100 bg-white p-6 shadow-soft">
        ...
        <div className="mt-4 text-sm text-slate-600 leading-relaxed space-y-4">
          ...
          <p>GoldMeter provides daily updated gold rates for Nashik.</p>
        </div>
      </section>
    </div>
  );
