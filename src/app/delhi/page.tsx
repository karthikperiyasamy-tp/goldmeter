...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Delhi Gold Rate Today (${todayFormatted}) - 22K & 24K Gold Price per Gram | GoldMeter`,
    description: `Delhi gold rate today (${todayFormatted}): 24K at ₹X/gram, 22K at ₹Y/gram. Check Chandni Chowk prices, making charges ₹220-600/g. Updated daily from IBJA.`,
    alternates: {
        ...
        <article className="mx-auto max-w-6xl px-4 pt-6">
          ...
          <div className="mt-4 rounded-2xl border border-slate-100 bg-white p-4 shadow-sm">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <a href="/kolkata" className="rounded-full bg-slate-50 px-3 py-1 text-sm text-slate-600 hover:bg-slate-100 transition-colors">
                Kolkata gold rate
              </a>
              ...
              <a href="/silver-rate/delhi" className="rounded-full bg-slate-50 px-3 py-1 text-sm text-slate-600 hover:bg-slate-100 transition-colors">
                Delhi silver rate
              </a>
            </div>
          </div>
