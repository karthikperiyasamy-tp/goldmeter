...
export default function CityGoldRateError({ error, reset }: ErrorPageProps) {
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-14">
      <section className="rounded-3xl border border-rose-200 bg-rose-50/40 p-6 shadow-soft">
        <p className="text-sm font-semibold text-rose-700">Unable to load city rates</p>
        <h1 className="mt-2 text-2xl font-bold text-charcoal">
          This city&apos;s gold rate page is temporarily unavailable.
        </h1>
        <p className="mt-3 text-sm text-slate-600">
          Please retry. You can also check the all-India gold rate while this recovers.
        </p>
